...
export default function HomePage() {
  return (
    <div className="flex flex-col gap-10 pb-10 md:gap-14">
            ...
            {PROCESS.map((p, idx) => (
              <Reveal key={p.step} delay={idx * 0.1}>
                <div className="relative flex flex-col items-center text-center">
                  <div className="flex size-12 items-center justify-center rounded-full bg-olive font-display text-lg font-bold text-white shadow-sm">
                    {p.step}
                  </div>
      ...
      {/* 7. Sección Donación / Colaboración */}
      <CtaBanner
        ...
        primaryButton={{
          text: 'Doná ahora',
          href: whatsappLink('Hola, quiero colaborar con una donación o insumos para el taller.'),
          isExternal: true,
          variant: 'default',
        }}
      />
